...
static NSString *const FB_AUTHORIZATION_ERROR = @"unauthorized";
static const HTTPStatusCode FB_AUTHORIZATION_ERROR_CODE = kHTTPStatusCodeUnauthorized;
static NSString *const FB_AUTHORIZATION_ERROR_MSG = @"Authentication is required for this WebDriverAgent endpoint";
...
+ (instancetype)authorizationErrorWithMessage:(NSString *)message
                                    traceback:(NSString *)traceback
{
  return [[FBCommandStatus alloc] initWithError:FB_AUTHORIZATION_ERROR
                                     statusCode:FB_AUTHORIZATION_ERROR_CODE
                                        message:message ?: FB_AUTHORIZATION_ERROR_MSG
                                      traceback:traceback];
}
