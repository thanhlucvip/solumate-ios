...
/**
 Creates TCP socket instance which is going to be started on the specified port and interface.

 @param port The actual port number
 @param interface The interface or address to bind. nil binds all interfaces.
 @return self instance
 */
- (instancetype)initWithPort:(uint16_t)port interface:(nullable NSString *)interface;
